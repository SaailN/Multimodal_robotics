...
def generate_launch_description():
    moveit_config_folder_name = 'ebot_ur5'

    xacro_file = get_package_file(moveit_config_folder_name, 'config/ebot.urdf.xacro')
    urdf_file = run_xacro(xacro_file)
    robot_description_arm = load_file(urdf_file)

    srdf_file = get_package_file(moveit_config_folder_name, 'config/ebot.srdf')
