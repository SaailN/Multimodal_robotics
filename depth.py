...
depth_image_path = '/content/Screenshot 2024-06-13 124939.png'  # Path to your depth image file
...
cv2.putText(color_image, text, (top_left[0], top_left[1] - 10), font, 0.5, (0, 255, 0), 2, cv2.LINE_AA)
